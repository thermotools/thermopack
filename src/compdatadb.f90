...
!! Time stamp: 2023-10-05T15:12:40.004318
...
module compdatadb
  ...
  type (alphadatadb), parameter :: twu25 = &
      ...
      cid="BUTANAL", &
      ref="tcPR", &
      coeff=(/1.97600000e-01, 8.50000000e-01, 2.54930000e+00/) &
      )
  ...
  type (cidatadb), parameter :: c25 = &
      ...
      cid="BUTANAL", &
      ref="tcPR", &
      bib_ref="Le Guennec et al. (2016): 10.1016/j.fluid.2016.09.003", &
      ciA=4.04360000e-06, &
      ciB=0.00000000e+00, &
      ciC=0.00000000e+00, &
      c_type=1 &
  ...
  type (alphadatadb), parameter :: twu26 = &
      ...
      cid="BUTANAL", &
      ref="tcRK", &
      coeff=(/2.81600000e-01, 8.54400000e-01, 2.47990000e+00/) &
      )
  ...
  type (gendatadb), parameter :: cx17 = &
      ...
      DfG = 0.0000, &
      psatcode = 1, &
      ant = (/4.06280000e+00, 8.61340000e+02, -2.68200000e+01/), &
      Tantmin = 176.3100, &
      Tantmax = 255.7900, &
      Zra = 0.277400, &
      mu_dipole = 0.000000, &
      q_quadrupole = 4.100000 &
      )

  type (cpdata), parameter :: cp18 = &
      cpdata(cid = "CL2", &
      ref = "Default", &
      bib_ref = "Poling et al. (2001): 978-0-07-011682-5", &
      cptype = 8, &
      cp = (/3.05600000e+00,5.37080000e-03,-8.09800000e-06,5.69300000e-09,-1.52560000e-12, &
      0.00000000e+00,0.00000000e+00,0.00000000e+00,0.00000000e+00,0.00000000e+00/), &
      Tcpmin = 50.0000, &
      Tcpmax = 1000.0000  &
      )
  ...
  type (alphadatadb), parameter :: twu31 = &
      ...
      cid="CL2", &
      ref="tcPR", &
      coeff=(/7.08200000e-01, 8.81200000e-01, 6.30600000e-01/) &
      )
  ...
  type (alphadatadb), parameter :: twu32 = &
      ...
      cid="CL2", &
      ref="tcRK", &
      coeff=(/3.92300000e-01, 8.52400000e-01, 1.21020000e+00/) &
      )
  ...
  type (cpdata), parameter :: cp24 = &
      cpdata(cid = "DME", &
      ref = "Default", &
      bib_ref = "The properties of gases and liquids, 5th ed. ISBN: 978-0-07-011682-5", &
      cptype = 8, &
      cp = (/4.36100000e+00,6.07000000e-03,2.89900000e-05,-3.58100000e-08,1.28200000e-11, &
      0.00000000e+00,0.00000000e+00,0.00000000e+00,0.00000000e+00,0.00000000e+00/), &
      Tcpmin = 100.0000, &
      Tcpmax = 1000.0000  &
      )

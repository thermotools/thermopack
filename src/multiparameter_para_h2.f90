module multiparameter_para_h2
  ...
  type, extends(meos) :: meos_para_h2
   ...
   contains
     ...
     procedure, public :: alpha0Derivs_hd_taudelta => alpha0Derivs_hd_PARA_H2
     procedure, public :: alphaResDerivs_hd_taudelta => alphaResDerivs_hd_PARA_H2
...
contains
  ...
  ! The functional form of the ideal gas function varies among multiparameter EoS,
  ! which explains why this routine may seem a bit hard-coded.
  function alpha0Derivs_hd_PARA_H2(this, delta, tau) result(alp0)
    use hyperdual_mod
    class(meos_para_h2) :: this
    ...
    enddo
  end function alpha0Derivs_hd_PARA_H2
  ...
  function alphaResDerivs_hd_PARA_H2 (this, delta, tau) result(alpr)
    use hyperdual_mod
    class(meos_para_h2) :: this
    type(hyperdual), intent(in) :: delta, tau
  ...
  end function alphaResDerivs_hd_PARA_H2

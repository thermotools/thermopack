...
!! Time stamp: 2024-02-01T17:02:29.755597
...
module pc_saft_datadb
  ...
  type(pc_saft_data), parameter :: PCcx78 = &
      pc_saft_data(eosidx = eosPC_SAFT, &
      compName = "NC11", &
      m = 4.864, &
      sigma = 3.8986e-10, &
  ...
  integer, parameter :: nPCmodels = 78
  ...
  type (PCkijdata), dimension(PCmaxkij), parameter :: PCkijdb = (/&
      ...
      PCSAFT_KIJ_31,PCSAFT_KIJ_32,PCSAFT_KIJ_33 &
  /)

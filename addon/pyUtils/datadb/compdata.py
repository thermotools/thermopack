...
class component(object):
    ...
    def get_comp_fortran_code(self):
        ...
        code_lines.append(3*I + f'sref_state = \"{self.comp["reference_state"]["entropy_ref_state"]}\", &')
        code_lines.append(3*I + 'href = {:.4f}'.format(self.comp["reference_state"]["enthalpy"]) + ", &")
        code_lines.append(3*I + f'href_state = \"{self.comp["reference_state"]["enthalpy_ref_state"]}\", &')

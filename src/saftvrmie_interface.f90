...
contains
  ...
  function calc_saftvrmie_zeta(nc,T,V,n) result(zeta)
    ...
    call calc_DFeynHibbsij(nc,T,saftvrmie_param%DFeynHibbsParam_ij, &
         saftvrmie_var(iTh)%DFeynHibbsij, saftvrmie_var(iTh)%D2FeynHibbsij)
    ! Calculate effective sigma
    call calc_binary_effective_sigma(nc,T,saftvrmie_var(iTh),saftvrmie_var(iTh)%sigma_eff%d,&
         saftvrmie_var(iTh)%sigma_eff%d_T,saftvrmie_var(iTh)%sigma_eff%d_TT)
    ! Calculate hard-sphere diameter
    call calc_hardsphere_diameter(nc,T,saftvrmie_var(iTh),saftvrmie_var(iTh)%sigma_eff%d,&
         saftvrmie_var(iTh)%sigma_eff%d_T,saftvrmie_var(iTh)%sigma_eff%d_TT,saftvrmie_var(iTh)%dhs%d,&
         saftvrmie_var(iTh)%dhs%d_T,saftvrmie_var(iTh)%dhs%d_TT)

    ! Calculate hypotetical pure fluid packing fraction
    call calcZetaX(nc,T,V,n,0,saftvrmie_var(iTh)%dhs,saftvrmie_var(iTh)%zeta)
    zeta = saftvrmie_var(iTh)%zeta%zx
  ...
  !!
  !! \author Morten Hammer, February 2018
  subroutine calcFresSAFTVRMie(nc,T,V,n,F,F_T,F_V,F_n,F_TT,&
...
subroutine testing()
  ...
  ii = 1
  jj = 1
  d = saftvrmie_var(1)%dhs%d(ii,jj)
  d_T = saftvrmie_var(1)%dhs%d_T(ii,jj)
  d_TT = saftvrmie_var(1)%dhs%d_TT(ii,jj)
  x0 = saftvrmie_param%sigma_ij(ii,jj)/d
  !eta = saftvrmie_var(1)%zeta%zx
  ...
  call calcZetaX(nc,T,V,n,3,saftvrmie_var(1)%dhs,saftvrmie_var(1)%zeta)
  call calcZetaX(nc,T,V+V*eps,n,3,saftvrmie_var(1)%dhs,zeta2)
  print *,"Testing hypotetical pure fluid packing fraction"
  print *,"Volume"
  print *,saftvrmie_var(1)%zeta%zx
  print *,saftvrmie_var(1)%zeta%zx_V,(zeta2%zx - saftvrmie_var(1)%zeta%zx)/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_VV,(zeta2%zx_V - saftvrmie_var(1)%zeta%zx_V)/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_TV,(zeta2%zx_T - saftvrmie_var(1)%zeta%zx_T)/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_Vn,(zeta2%zx_n - saftvrmie_var(1)%zeta%zx_n)/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_VVV,(zeta2%zx_VV - saftvrmie_var(1)%zeta%zx_VV)/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_VVT,(zeta2%zx_TV - saftvrmie_var(1)%zeta%zx_TV)/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_VTT,(zeta2%zx_TT - saftvrmie_var(1)%zeta%zx_TT)/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_VTn,(zeta2%zx_Tn - saftvrmie_var(1)%zeta%zx_Tn)/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_VVn,(zeta2%zx_Vn - saftvrmie_var(1)%zeta%zx_Vn)/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_Vnn(1,:),(zeta2%zx_nn(1,:) - saftvrmie_var(1)%zeta%zx_nn(1,:))/(V*eps)
  print *,saftvrmie_var(1)%zeta%zx_Vnn(2,:),(zeta2%zx_nn(2,:) - saftvrmie_var(1)%zeta%zx_nn(2,:))/(V*eps)

  n(1) = n(1) + eps
  call calcZetaX(nc,T,V,n,3,saftvrmie_var(1)%dhs,zeta2)
  print *,"n(1)"
  print *,saftvrmie_var(1)%zeta%zx_n(1),(zeta2%zx - saftvrmie_var(1)%zeta%zx)/eps
  print *,saftvrmie_var(1)%zeta%zx_Tn(1),(zeta2%zx_T - saftvrmie_var(1)%zeta%zx_T)/eps
  print *,saftvrmie_var(1)%zeta%zx_Vn(1),(zeta2%zx_V - saftvrmie_var(1)%zeta%zx_V)/eps
  print *,saftvrmie_var(1)%zeta%zx_nn(1,:),(zeta2%zx_n - saftvrmie_var(1)%zeta%zx_n)/eps
  print *,saftvrmie_var(1)%zeta%zx_VVn(1),(zeta2%zx_VV - saftvrmie_var(1)%zeta%zx_VV)/eps
  print *,saftvrmie_var(1)%zeta%zx_Vnn(1,:),(zeta2%zx_Vn - saftvrmie_var(1)%zeta%zx_Vn)/eps
  print *,saftvrmie_var(1)%zeta%zx_VTn(1),(zeta2%zx_TV - saftvrmie_var(1)%zeta%zx_TV)/eps

  n = n0
  n(2) = n(2) + eps
  call calcZetaX(nc,T,V,n,3,saftvrmie_var(1)%dhs,zeta2)
  print *,"n(2)"
  print *,saftvrmie_var(1)%zeta%zx_n(2),(zeta2%zx - saftvrmie_var(1)%zeta%zx)/eps
  print *,saftvrmie_var(1)%zeta%zx_Tn(2),(zeta2%zx_T - saftvrmie_var(1)%zeta%zx_T)/eps
  print *,saftvrmie_var(1)%zeta%zx_Vn(2),(zeta2%zx_V - saftvrmie_var(1)%zeta%zx_V)/eps
  print *,saftvrmie_var(1)%zeta%zx_nn(2,:),(zeta2%zx_n - saftvrmie_var(1)%zeta%zx_n)/eps
  print *,saftvrmie_var(1)%zeta%zx_VVn(2),(zeta2%zx_VV - saftvrmie_var(1)%zeta%zx_VV)/eps
  print *,saftvrmie_var(1)%zeta%zx_Vnn(2,:),(zeta2%zx_Vn - saftvrmie_var(1)%zeta%zx_Vn)/eps
  print *,saftvrmie_var(1)%zeta%zx_VTn(2),(zeta2%zx_TV - saftvrmie_var(1)%zeta%zx_TV)/eps

  n = n0
  call allocate_saftvrmie_dhs(nc,dhs)
  ! Calculate effective sigma
  call calc_binary_effective_sigma(nc,T+eps,saftvrmie_var(1),saftvrmie_var(1)%sigma_eff%d,&
       saftvrmie_var(1)%sigma_eff%d_T,saftvrmie_var(1)%sigma_eff%d_TT)
  ! Calculate hard-sphere diameter
  call calc_hardsphere_diameter(nc,T+eps,saftvrmie_var(1),saftvrmie_var(1)%sigma_eff%d,&
       saftvrmie_var(1)%sigma_eff%d_T,saftvrmie_var(1)%sigma_eff%d_TT,saftvrmie_var(1)%dhs%d,&
       saftvrmie_var(1)%dhs%d_T,saftvrmie_var(1)%dhs%d_TT)
  call calcZetaX(nc,T+eps,V,n,3,saftvrmie_var(1)%dhs,zeta2)
  print *,"Temperature"
  print *,saftvrmie_var(1)%zeta%zx_T,(zeta2%zx - saftvrmie_var(1)%zeta%zx)/eps
  print *,saftvrmie_var(1)%zeta%zx_TT,(zeta2%zx_T - saftvrmie_var(1)%zeta%zx_T)/eps
  print *,saftvrmie_var(1)%zeta%zx_TV,(zeta2%zx_V - saftvrmie_var(1)%zeta%zx_V)/eps
  print *,saftvrmie_var(1)%zeta%zx_Tn,(zeta2%zx_n - saftvrmie_var(1)%zeta%zx_n)/eps
  print *,saftvrmie_var(1)%zeta%zx_VVT,(zeta2%zx_VV - saftvrmie_var(1)%zeta%zx_VV)/eps
  print *,saftvrmie_var(1)%zeta%zx_VTT,(zeta2%zx_TV - saftvrmie_var(1)%zeta%zx_TV)/eps
  print *,saftvrmie_var(1)%zeta%zx_VTn,(zeta2%zx_Vn - saftvrmie_var(1)%zeta%zx_Vn)/eps
  ...
  call calc_binary_effective_sigma(nc,T,saftvrmie_var(1),saftvrmie_var(1)%sigma_eff%d,&
       saftvrmie_var(1)%sigma_eff%d_T,saftvrmie_var(1)%sigma_eff%d_TT)
  call calcZetaX(nc,T,V,n,3,saftvrmie_var(1)%sigma_eff,saftvrmie_var(1)%zeta_bar)
  call calcZetaX(nc,T,V+V*eps,n,3,saftvrmie_var(1)%sigma_eff,zeta2)
  print *,"Testing packing fraction"
  print *,"Volume"
  print *,saftvrmie_var(1)%zeta_bar%zx
  print *,saftvrmie_var(1)%zeta_bar%zx_V,(zeta2%zx - saftvrmie_var(1)%zeta_bar%zx)/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_VV,(zeta2%zx_V - saftvrmie_var(1)%zeta_bar%zx_V)/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_TV,(zeta2%zx_T - saftvrmie_var(1)%zeta_bar%zx_T)/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_Vn,(zeta2%zx_n - saftvrmie_var(1)%zeta_bar%zx_n)/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_VVV,(zeta2%zx_VV - saftvrmie_var(1)%zeta_bar%zx_VV)/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_VVT,(zeta2%zx_TV - saftvrmie_var(1)%zeta_bar%zx_TV)/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_VTT,(zeta2%zx_TT - saftvrmie_var(1)%zeta_bar%zx_TT)/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_VTn,(zeta2%zx_Tn - saftvrmie_var(1)%zeta_bar%zx_Tn)/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_VVn,(zeta2%zx_Vn - saftvrmie_var(1)%zeta_bar%zx_Vn)/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_Vnn(1,:),(zeta2%zx_nn(1,:) - saftvrmie_var(1)%zeta_bar%zx_nn(1,:))/(V*eps)
  print *,saftvrmie_var(1)%zeta_bar%zx_Vnn(2,:),(zeta2%zx_nn(2,:) - saftvrmie_var(1)%zeta_bar%zx_nn(2,:))/(V*eps)

  n(1) = n(1) + eps
  call calcZetaX(nc,T,V,n,3,saftvrmie_var(1)%sigma_eff,zeta2)
  print *,"n(1)"
  print *,saftvrmie_var(1)%zeta_bar%zx_n(1),(zeta2%zx - saftvrmie_var(1)%zeta_bar%zx)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_Tn(1),(zeta2%zx_T - saftvrmie_var(1)%zeta_bar%zx_T)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_Vn(1),(zeta2%zx_V - saftvrmie_var(1)%zeta_bar%zx_V)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_nn(1,:),(zeta2%zx_n - saftvrmie_var(1)%zeta_bar%zx_n)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_VVn(1),(zeta2%zx_VV - saftvrmie_var(1)%zeta_bar%zx_VV)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_Vnn(1,:),(zeta2%zx_Vn - saftvrmie_var(1)%zeta_bar%zx_Vn)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_VTn(1),(zeta2%zx_TV - saftvrmie_var(1)%zeta_bar%zx_TV)/eps
  !stop
  n = n0
  n(2) = n(2) + eps
  call calcZetaX(nc,T,V,n,3,saftvrmie_var(1)%sigma_eff,zeta2)
  print *,"n(2)"
  print *,saftvrmie_var(1)%zeta_bar%zx_n(2),(zeta2%zx - saftvrmie_var(1)%zeta_bar%zx)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_Tn(2),(zeta2%zx_T - saftvrmie_var(1)%zeta_bar%zx_T)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_Vn(2),(zeta2%zx_V - saftvrmie_var(1)%zeta_bar%zx_V)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_nn(2,:),(zeta2%zx_n - saftvrmie_var(1)%zeta_bar%zx_n)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_VVn(2),(zeta2%zx_VV - saftvrmie_var(1)%zeta_bar%zx_VV)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_Vnn(2,:),(zeta2%zx_Vn - saftvrmie_var(1)%zeta_bar%zx_Vn)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_VTn(2),(zeta2%zx_TV - saftvrmie_var(1)%zeta_bar%zx_TV)/eps
  !stop
  n = n0

  call calc_binary_effective_sigma(nc,T+eps,saftvrmie_var(1),saftvrmie_var(1)%sigma_eff%d,&
       saftvrmie_var(1)%sigma_eff%d_T,saftvrmie_var(1)%sigma_eff%d_TT)
  call calcZetaX(nc,T+eps,V,n,3,saftvrmie_var(1)%sigma_eff,zeta2)
  print *,"Temperature"
  print *,saftvrmie_var(1)%zeta_bar%zx_T,(zeta2%zx - saftvrmie_var(1)%zeta_bar%zx)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_TT,(zeta2%zx_T - saftvrmie_var(1)%zeta_bar%zx_T)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_TV,(zeta2%zx_V - saftvrmie_var(1)%zeta_bar%zx_V)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_Tn,(zeta2%zx_n - saftvrmie_var(1)%zeta_bar%zx_n)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_VVT,(zeta2%zx_VV - saftvrmie_var(1)%zeta_bar%zx_VV)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_VTT,(zeta2%zx_TV - saftvrmie_var(1)%zeta_bar%zx_TV)/eps
  print *,saftvrmie_var(1)%zeta_bar%zx_VTn,(zeta2%zx_Vn - saftvrmie_var(1)%zeta_bar%zx_Vn)/eps

  ! Test x0 differentials
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calcXDifferentials(saftvrmie_var(1)%sigma_eff%d(ii,jj),&
       saftvrmie_var(1)%sigma_eff%d_T(ii,jj),&
       saftvrmie_var(1)%sigma_eff%d_TT(ii,jj),&
       saftvrmie_var(1)%dhs%d(ii,jj),saftvrmie_var(1)%dhs%d_T(ii,jj),&
       saftvrmie_var(1)%dhs%d_TT(ii,jj),x0,x0_T,x0_TT)
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calcXDifferentials(saftvrmie_var(1)%sigma_eff%d(ii,jj),&
       saftvrmie_var(1)%sigma_eff%d_T(ii,jj),&
       saftvrmie_var(1)%sigma_eff%d_TT(ii,jj),saftvrmie_var(1)%dhs%d(ii,jj),&
       saftvrmie_var(1)%dhs%d_T(ii,jj),&
       saftvrmie_var(1)%dhs%d_TT(ii,jj),x02,x02_T,x02_TT)
...
subroutine test_Khs_TVn()
  ...
  call calcZetaX(nc,T,V+V*eps,n,3,saftvrmie_var(1)%dhs,zeta2)
  call calcKhsTVn(nc,T,V+V*eps,n,3,saftvrmie_var(1))
  print *,"Testing Khs"
  print *,"Volume"
  print *,saftvrmie_var(1)%Khs%zx
  print *,saftvrmie_var(1)%Khs%zx_V,(khs%zx - saftvrmie_var(1)%Khs%zx)/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_VV,(khs%zx_V - saftvrmie_var(1)%Khs%zx_V)/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_TV,(khs%zx_T - saftvrmie_var(1)%Khs%zx_T)/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_Vn,(khs%zx_n - saftvrmie_var(1)%Khs%zx_n)/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_VVV,(khs%zx_VV - saftvrmie_var(1)%Khs%zx_VV)/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_VVT,(khs%zx_TV - saftvrmie_var(1)%Khs%zx_TV)/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_VTT,(khs%zx_TT - saftvrmie_var(1)%Khs%zx_TT)/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_VTn,(khs%zx_Tn - saftvrmie_var(1)%Khs%zx_Tn)/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_VVn,(khs%zx_Vn - saftvrmie_var(1)%Khs%zx_Vn)/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_Vnn(1,:),(khs%zx_nn(1,:) - saftvrmie_var(1)%Khs%zx_nn(1,:))/(V*eps)
  print *,saftvrmie_var(1)%Khs%zx_Vnn(2,:),(khs%zx_nn(2,:) - saftvrmie_var(1)%Khs%zx_nn(2,:))/(V*eps)

  n(1) = n(1) + eps
  call calcZetaX(nc,T,V,n,3,saftvrmie_var(1)%dhs,zeta2)
  call calcKhsTVn(nc,T,V,n,3,saftvrmie_var(1))
  print *,"n1"
  print *,saftvrmie_var(1)%Khs%zx_n(1),(khs%zx - saftvrmie_var(1)%Khs%zx)/eps
  print *,saftvrmie_var(1)%Khs%zx_Tn(1),(khs%zx_T - saftvrmie_var(1)%Khs%zx_T)/eps
  print *,saftvrmie_var(1)%Khs%zx_Vn(1),(khs%zx_V - saftvrmie_var(1)%Khs%zx_V)/eps
  print *,saftvrmie_var(1)%Khs%zx_nn(1,:),(khs%zx_n - saftvrmie_var(1)%Khs%zx_n)/eps
  print *,saftvrmie_var(1)%Khs%zx_VVn(1),(khs%zx_VV - saftvrmie_var(1)%Khs%zx_VV)/eps
  print *,saftvrmie_var(1)%Khs%zx_Vnn(1,:),(khs%zx_Vn - saftvrmie_var(1)%Khs%zx_Vn)/eps
  print *,saftvrmie_var(1)%Khs%zx_VTn(1),(khs%zx_TV - saftvrmie_var(1)%Khs%zx_TV)/eps
  ...
  call calcKhsTVn(nc,T,V,n,3,saftvrmie_var(1))
  print *,"n2"
  print *,saftvrmie_var(1)%Khs%zx_n(2),(khs%zx - saftvrmie_var(1)%Khs%zx)/eps
  print *,saftvrmie_var(1)%Khs%zx_Tn(2),(khs%zx_T - saftvrmie_var(1)%Khs%zx_T)/eps
  print *,saftvrmie_var(1)%Khs%zx_Vn(2),(khs%zx_V - saftvrmie_var(1)%Khs%zx_V)/eps
  print *,saftvrmie_var(1)%Khs%zx_nn(2,:),(khs%zx_n - saftvrmie_var(1)%Khs%zx_n)/eps
  print *,saftvrmie_var(1)%Khs%zx_VVn(2),(khs%zx_VV - saftvrmie_var(1)%Khs%zx_VV)/eps
  print *,saftvrmie_var(1)%Khs%zx_Vnn(2,:),(khs%zx_Vn - saftvrmie_var(1)%Khs%zx_Vn)/eps
  print *,saftvrmie_var(1)%Khs%zx_VTn(2),(khs%zx_TV - saftvrmie_var(1)%Khs%zx_TV)/eps

  n = n0
  ! Calculate effective sigma
  call calc_binary_effective_sigma(nc,T+T*eps,saftvrmie_var(1),saftvrmie_var(1)%sigma_eff%d,&
       saftvrmie_var(1)%sigma_eff%d_T,saftvrmie_var(1)%sigma_eff%d_TT)
  ! Calculate hard-sphere diameter
  call calc_hardsphere_diameter(nc,T+T*eps,saftvrmie_var(1),saftvrmie_var(1)%sigma_eff%d,&
       saftvrmie_var(1)%sigma_eff%d_T,saftvrmie_var(1)%sigma_eff%d_TT,saftvrmie_var(1)%dhs%d,&
       saftvrmie_var(1)%dhs%d_T,saftvrmie_var(1)%dhs%d_TT)
  call calcZetaX(nc,T+T*eps,V,n,3,saftvrmie_var(1)%dhs,zeta2)
  call calcKhsTVn(nc,T+T*eps,V,n,3,saftvrmie_var(1))
  print *,"Temperature"
  print *,saftvrmie_var(1)%Khs%zx_T,(khs%zx - saftvrmie_var(1)%Khs%zx)/(T*eps)
  print *,saftvrmie_var(1)%Khs%zx_TT,(khs%zx_T - saftvrmie_var(1)%Khs%zx_T)/(T*eps)
  print *,saftvrmie_var(1)%Khs%zx_TV,(khs%zx_V - saftvrmie_var(1)%Khs%zx_V)/(T*eps)
  print *,saftvrmie_var(1)%Khs%zx_Tn,(khs%zx_n - saftvrmie_var(1)%Khs%zx_n)/(T*eps)
  print *,saftvrmie_var(1)%Khs%zx_VVT,(khs%zx_VV - saftvrmie_var(1)%Khs%zx_VV)/(T*eps)
  print *,saftvrmie_var(1)%Khs%zx_VTT,(khs%zx_TV - saftvrmie_var(1)%Khs%zx_TV)/(T*eps)
  print *,saftvrmie_var(1)%Khs%zx_VTn,(khs%zx_Vn - saftvrmie_var(1)%Khs%zx_Vn)/(T*eps)
  stop
...
subroutine test_A1ij()
  ...
  j = 2
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  !call calcA1TildeTVn(nc,T,V,n,i,j,saftvrmie_var(1)%dhs,saftvrmie_var(1)%zeta,&
  !     a1,a1_T,a1_V,a1_n,a1_TT,a1_VV,a1_TV,a1_Tn,a1_Vn,a1_nn,&
  !     a1_VVV,a1_VVT,a1_VTT,a1_VVn,a1_Vnn,a1_VTn)
  call calcA1ij(nc,T,V,n,i,j,saftvrmie_var(1),&
       a1,a1_T,a1_V,a1_n,a1_TT,a1_VV,a1_TV,a1_Tn,a1_Vn,a1_nn,&
       a1_VVV,a1_VVT,a1_VTT,a1_VVn,a1_Vnn,a1_VTn)
  ...
  ! a1_Vnn=0.0
  ! a1_VTn=0.0
  ! call eta_a_product(nc,T,V,n,saftvrmie_var(1)%dhs%d(i,j),saftvrmie_var(1)%dhs%d_T(i,j),&
  !      saftvrmie_var(1)%dhs%d_TT(i,j),&
  !      a1,a1_T,a1_V,a1_n,a1_TT,a1_VV,a1_TV,a1_Tn,a1_Vn,a1_nn,&
  !      a1_VVV,a1_VVT,a1_VTT,a1_VVn,a1_Vnn,a1_VTn)
  call allocate_saftvrmie_var_container(nc,s_vc)
  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,s_vc)
  !call calcA1TildeTVn(nc,T,V,n,i,j,saftvrmie_var(1)%dhs,zeta,&
  ...
  ! a1p_Vnn=0.0
  ! a1p_VTn=0.0
  ! call eta_a_product(nc,T,V+V*eps,n,saftvrmie_var(1)%dhs%d(i,j),saftvrmie_var(1)%dhs%d_T(i,j),&
  !      saftvrmie_var(1)%dhs%d_TT(i,j),&
  !      a1p,a1p_T,a1p_V,a1p_n,a1p_TT,a1p_VV,a1p_TV,a1p_Tn,a1p_Vn,a1p_nn,&
  !      a1p_VVV,a1p_VVT,a1p_VTT,a1p_VVn,a1p_Vnn,a1p_VTn)
  !call allocate_saftvrmie_zeta(nc,khs)
  ...
  ! a1p_Vnn=0.0
  ! a1p_VTn=0.0
  ! call eta_a_product(nc,T+eps,V,n,saftvrmie_var(1)%dhs%d(i,j),saftvrmie_var(1)%dhs%d_T(i,j),&
  !      saftvrmie_var(1)%dhs%d_TT(i,j),&
  !      a1p,a1p_T,a1p_V,a1p_n,a1p_TT,a1p_VV,a1p_TV,a1p_Tn,a1p_Vn,a1p_nn,&
  !      a1p_VVV,a1p_VVT,a1p_VTT,a1p_VVn,a1p_Vnn,a1p_VTn)
...
subroutine test_A1()
  ...
  call calcA1(nc,T,V+V*eps,n,saftvrmie_var(1),&
       a1p,a1p_T,a1p_V,a1p_n,a1p_TT,a1p_VV,a1p_TV,a1p_Tn,a1p_Vn,a1p_nn,&
       a1p_VVV,a1p_VVT,a1p_VTT,a1p_VVn,a1p_Vnn,a1p_VTn)
  ...
  n = n0
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calcA1(nc,T+T*eps,V,n,saftvrmie_var(1),&
       a1p,a1p_T,a1p_V,a1p_n,a1p_TT,a1p_VV,a1p_TV,a1p_Tn,a1p_Vn,a1p_nn,&
       a1p_VVV,a1p_VVT,a1p_VTT,a1p_VVn,a1p_Vnn,a1p_VTn)
  print *,a1_T,(a1p - a1)/(T*eps)
  print *,a1_TT,(a1p_T - a1_T)/(T*eps)
...
subroutine test_A2_tilde()
  ...
  print *,"Testing A22"
  d = saftvrmie_var(1)%dhs%d(i,j)
  d_T = saftvrmie_var(1)%dhs%d_T(i,j)
  d_TT = saftvrmie_var(1)%dhs%d_TT(i,j)
...
subroutine test_A2()
  ...
  call calcA2(nc,T,V,n,saftvrmie_var(1),&
       a1,a1_T,a1_V,a1_n,a1_TT,a1_VV,a1_TV,a1_Tn,a1_Vn,a1_nn)
  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calcA2(nc,T,V+V*eps,n,saftvrmie_var(1),&
       a1p,a1p_T,a1p_V,a1p_n,a1p_TT,a1p_VV,a1p_TV,a1p_Tn,a1p_Vn,a1p_nn)
  ...
  n = n0
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calcA2(nc,T+T*eps,V,n,saftvrmie_var(1),&
       a1p,a1p_T,a1p_V,a1p_n,a1p_TT,a1p_VV,a1p_TV,a1p_Tn,a1p_Vn,a1p_nn)
  print *,a1_T,(a1p - a1)/(T*eps)
  print *,a1_TT,(a1p_T - a1_T)/(T*eps)
  print *,a1_TV,(a1p_V - a1_V)/(T*eps)
...
subroutine test_A3()
  ...
  z = saftvrmie_var(1)%zeta_bar%zx
  call calcA3zeta(saftvrmie_param%eps_divk_ij(i,j), z, saftvrmie_var(1)%alpha%d(i,j),&
       saftvrmie_param%f_alpha_ij(:,i,j), a3, a3_z, a3_zz, a3_a, a3_aa, a3_az)
  call calcA3zeta(saftvrmie_param%eps_divk_ij(i,j), z+eps, saftvrmie_var(1)%alpha%d(i,j),&
  ...
  call calcA3zeta(saftvrmie_param%eps_divk_ij(i,j), z, saftvrmie_var(1)%alpha%d(i,j) + eps,&
       saftvrmie_param%f_alpha_ij(:,i,j), a32, a32_z, a32_zz, a32_a, a32_aa, a32_az)
  ...
  call calcA3(nc,T,V,n,saftvrmie_var(1),&
       a1,a1_T,a1_V,a1_n,a1_TT,a1_VV,a1_TV,a1_Tn,a1_Vn,a1_nn)
  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calcA3(nc,T,V+V*eps,n,saftvrmie_var(1),&
       a1p,a1p_T,a1p_V,a1p_n,a1p_TT,a1p_VV,a1p_TV,a1p_Tn,a1p_Vn,a1p_nn)
  ...
  n = n0
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calcA3(nc,T+T*eps,V,n,saftvrmie_var(1),&
       a1p,a1p_T,a1p_V,a1p_n,a1p_TT,a1p_VV,a1p_TV,a1p_Tn,a1p_Vn,a1p_nn)
  print *,a1_T,(a1p - a1)/(T*eps)
  print *,a1_TT,(a1p_T - a1_T)/(T*eps)
  print *,a1_TV,(a1p_V - a1_V)/(T*eps)
...
subroutine test_g0(Ti,Vi,ni,doInit,qc)
  ...
  eta = saftvrmie_var(1)%zeta%zx
  x0 = saftvrmie_param%sigma_ij(i,i)/saftvrmie_var(1)%dhs%d(i,i)
  ...
  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call rdf_at_contact_zeroth_order_TVn(nc,T,V+V*eps,n,saftvrmie_var(1),&
  ...
  n = n0
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call rdf_at_contact_zeroth_order_TVn(nc,T+T*eps,V,n,saftvrmie_var(1),&
       g02,g02_T,g02_V,g02_n,g02_TT,g02_VV,g02_TV,g02_Tn,g02_Vn,g02_nn)
...
subroutine test_g1(Ti,Vi,ni,doInit,qc)
  ...
  call calcA1(nc,T,V+V*eps,n,saftvrmie_var(1),&
       ...
       a1_VVV=a1_VVV,a1_VVT=a1_VVT,a1_VTT=a1_VTT,a1_VVn=a1_VVn,a1_Vnn=a1_Vnn,a1_VTn=a1_VTn)
  call calcG11_if(nc,T,V+V*eps,n,i,saftvrmie_var(1),&
  ...
  call calcA1(nc,T+T*eps,V,n,saftvrmie_var(1),&
       ...
       a1_TV=g12_TV(i),a1_Tn=g12_Tn(:,i),a1_Vn=g12_Vn(:,i),a1_nn=g12_nn(:,:,i),&
       a1_VVV=a1_VVV,a1_VVT=a1_VVT,a1_VTT=a1_VTT,a1_VVn=a1_VVn,a1_Vnn=a1_Vnn,a1_VTn=a1_VTn)
  call calcG11_if(nc,T+T*eps,V,n,i,saftvrmie_var(1),&
       g12(i),g12_T(i),g12_V(i),g12_n(:,i),g12_TT(i),g12_VV(i),g12_TV(i),&
       g12_Tn(:,i),g12_Vn(:,i),g12_nn(:,:,i))
  ...
  call calcA1(nc,T,V+V*eps,n,saftvrmie_var(1),&
       ...
       a1_TV=g12_TV(i),a1_Tn=g12_Tn(:,i),a1_Vn=g12_Vn(:,i),a1_nn=g12_nn(:,:,i),&
       a1_VVV=a1_VVV,a1_VVT=a1_VVT,a1_VTT=a1_VTT,a1_VVn=a1_VVn,a1_Vnn=a1_Vnn,a1_VTn=a1_VTn)
  call rdf_at_contact_first_order_TVn(nc,T,V+V*eps,n,saftvrmie_var(1),&
  ...
  call calcA1(nc,T+T*eps,V,n,saftvrmie_var(1),&
       ...
       a1_TV=g12_TV(i),a1_Tn=g12_Tn(:,i),a1_Vn=g12_Vn(:,i),a1_nn=g12_nn(:,:,i),&
       a1_VVV=a1_VVV,a1_VVT=a1_VVT,a1_VTT=a1_VTT,a1_VVn=a1_VVn,a1_Vnn=a1_Vnn,a1_VTn=a1_VTn)
  call rdf_at_contact_first_order_TVn(nc,T+T*eps,V,n,saftvrmie_var(1),&
       g12,g12_T,g12_V,g12_n,g12_TT,g12_VV,g12_TV,&
       g12_Tn,g12_Vn,g12_nn)
...
subroutine test_g2(Ti,Vi,ni,doInit,qc)
  ...
  g2_Vn = saftvrmie_var(1)%a2chij%am_Vn(:,i,i)
  g2_VVn = saftvrmie_var(1)%a2chij%am_VVn(:,i,i)

  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calcA2(nc,T,V+V*eps,n,saftvrmie_var(1),&
       g12(i),a2_T=g12_T(i),a2_V=g12_V(i),a2_n=g12_n(:,i),a2_TT=g12_TT(i),a2_VV=g12_VV(i),&
       a2_TV=g12_TV(i),a2_Tn=g12_Tn(:,i),a2_Vn=g12_Vn(:,i),a2_nn=g12_nn(:,:,i))
  call rdf_at_contact_second_order_TVn(nc,T,V+V*eps,n,saftvrmie_var(1),no_correction,&
       g12,g12_T,g12_V,g12_n,g12_TT,g12_VV,g12_TV,&
       g12_Tn,g12_Vn,g12_nn)
  g2p_Vn = saftvrmie_var(1)%a2chij%am_Vn(:,i,i)
  print *,"Testing g2"
  print *,"V"
  print *,g1(i)
  print *,g1_V(i),(g12(i) - g1(i))/(V*eps)
  ...
  call calcA2(nc,T+T*eps,V,n,saftvrmie_var(1),&
       g12(i),a2_T=g12_T(i),a2_V=g12_V(i),a2_n=g12_n(:,i),a2_TT=g12_TT(i),a2_VV=g12_VV(i),&
       a2_TV=g12_TV(i),a2_Tn=g12_Tn(:,i),a2_Vn=g12_Vn(:,i),a2_nn=g12_nn(:,:,i))
  call rdf_at_contact_second_order_TVn(nc,T+T*eps,V,n,saftvrmie_var(1),no_correction,&
       g12,g12_T,g12_V,g12_n,g12_TT,g12_VV,g12_TV,&
       g12_Tn,g12_Vn,g12_nn)
...
subroutine test_rdf_at_contact(Ti,Vi,ni,doInit,qc)
  ...
  call calcA2(nc,T,V+V*eps,n,saftvrmie_var(1),&
       g12(i),a2_T=g12_T(i),a2_V=g12_V(i),a2_n=g12_n(:,i),a2_TT=g12_TT(i),a2_VV=g12_VV(i),&
       a2_TV=g12_TV(i),a2_Tn=g12_Tn(:,i),a2_Vn=g12_Vn(:,i),a2_nn=g12_nn(:,:,i))
  call rdf_at_contact(nc,T,V+V*eps,n,saftvrmie_var(1),&
       g12,g12_T,g12_V,g12_n,g12_TT,g12_VV,g12_TV,&
       g12_Tn,g12_Vn,g12_nn)
  print *,"Testing g1"
  print *,"V"
  ...
  call calcA2(nc,T+T*eps,V,n,saftvrmie_var(1),&
       g12(i),a2_T=g12_T(i),a2_V=g12_V(i),a2_n=g12_n(:,i),a2_TT=g12_TT(i),a2_VV=g12_VV(i),&
       a2_TV=g12_TV(i),a2_Tn=g12_Tn(:,i),a2_Vn=g12_Vn(:,i),a2_nn=g12_nn(:,:,i))
  call rdf_at_contact(nc,T+T*eps,V,n,saftvrmie_var(1),&
       g12,g12_T,g12_V,g12_n,g12_TT,g12_VV,g12_TV,&
       g12_Tn,g12_Vn,g12_nn)
...
subroutine test_a_chain
  ...
  call calcA2(nc,T,V,n,saftvrmie_var(1),&
       g12(i),a2_T=g12_T(i),a2_V=g12_V(i),a2_n=g12_n(:,i),a2_TT=g12_TT(i),a2_VV=g12_VV(i),&
       a2_TV=g12_TV(i),a2_Tn=g12_Tn(:,i),a2_Vn=g12_Vn(:,i),a2_nn=g12_nn(:,:,i))
  call calcAchain(nc,T,V,n,saftvrmie_var(1),ach,ach_T,ach_V,ach_n,ach_TT,&
  ...
  call calcA2(nc,T,V+V*eps,n,saftvrmie_var(1),&
       g12(i),a2_T=g12_T(i),a2_V=g12_V(i),a2_n=g12_n(:,i),a2_TT=g12_TT(i),a2_VV=g12_VV(i),&
       a2_TV=g12_TV(i),a2_Tn=g12_Tn(:,i),a2_Vn=g12_Vn(:,i),a2_nn=g12_nn(:,:,i))
  call calcAchain(nc,T,V+V*eps,n,saftvrmie_var(1),ach2,ach2_T,ach2_V,ach2_n,ach2_TT,&
  ...
  call calcA2(nc,T,V,n,saftvrmie_var(1),&
       g12(i),a2_T=g12_T(i),a2_V=g12_V(i),a2_n=g12_n(:,i),a2_TT=g12_TT(i),a2_VV=g12_VV(i),&
       a2_TV=g12_TV(i),a2_Tn=g12_Tn(:,i),a2_Vn=g12_Vn(:,i),a2_nn=g12_nn(:,:,i))
  call calcAchain(nc,T,V,n,saftvrmie_var(1),ach2,ach2_T,ach2_V,ach2_n,ach2_TT,&
       ach2_VV,ach2_TV,ach2_Tn,ach2_Vn,ach2_nn)
  ...
  call calcA2(nc,T+T*eps,V,n,saftvrmie_var(1),&
       g12(i),a2_T=g12_T(i),a2_V=g12_V(i),a2_n=g12_n(:,i),a2_TT=g12_TT(i),a2_VV=g12_VV(i),&
       a2_TV=g12_TV(i),a2_Tn=g12_Tn(:,i),a2_Vn=g12_Vn(:,i),a2_nn=g12_nn(:,:,i))
  call calcAchain(nc,T+T*eps,V,n,saftvrmie_var(1),ach2,ach2_T,ach2_V,ach2_n,ach2_TT,&
       ach2_VV,ach2_TV,ach2_Tn,ach2_Vn,ach2_nn)
...
subroutine test_fres(Ti,Vi,ni,doInit)
  ...
  call calcFresSAFTVRMie(nc,T,V,n,F,F_T,F_V,F_n,F_TT,&
       F_VV,F_TV,F_Tn,F_Vn,F_nn)
  call calcFresSAFTVRMie(nc,T,V+V*eps,n,Fp,Fp_T,Fp_V,Fp_n,Fp_TT,&
  ...
  print *,"T"
  n = n0
  call calcFresSAFTVRMie(nc,T+T*eps,V,n,Fp,Fp_T,Fp_V,Fp_n,Fp_TT,&
       Fp_VV,Fp_TV,Fp_Tn,Fp_Vn,Fp_nn)
...
subroutine test_a1_quantum_corrections()
  ...
  print *, "TEST A1QTILDE"
  ! call calcFresSAFTVRMie(nc,T,V,n0,F,F_T,F_V,F_n,F_TT,&
  !      F_VV,F_TV,F_Tn,F_Vn,F_nn)
  ...
  call calcFresSAFTVRMie(nc,T,V,n0,F,F_T,F_V,F_n,F_TT,&
       F_VV,F_TV,F_Tn,F_Vn,F_nn)
  call calcFresSAFTVRMie(nc,T,V+V*eps,n0,Fp,Fp_T,Fp_V,Fp_n,Fp_TT,&
       Fp_VV,Fp_TV,Fp_Tn,Fp_Vn,Fp_nn)
  call calcFresSAFTVRMie(nc,T,V-V*eps,n0,Fm,Fm_T,Fm_V,Fm_n,Fm_TT,&
  ...
  call calcFresSAFTVRMie(nc,T,V,n,Fp,Fp_T,Fp_V,Fp_n,Fp_TT,&
       Fp_VV,Fp_TV,Fp_Tn,Fp_Vn,Fp_nn)
  n(1) = n0(1) - eps
  call calcFresSAFTVRMie(nc,T,V,n,Fm,Fm_T,Fm_V,Fm_n,Fm_TT,&
       Fm_VV,Fm_TV,Fm_Tn,Fm_Vn,Fm_nn)
  ...
  print *,"T"
  n = n0
  call calcFresSAFTVRMie(nc,T+T*eps,V,n0,Fp,Fp_T,Fp_V,Fp_n,Fp_TT,&
       Fp_VV,Fp_TV,Fp_Tn,Fp_Vn,Fp_nn)
  call calcFresSAFTVRMie(nc,T-T*eps,V,n0,Fm,Fm_T,Fm_V,Fm_n,Fm_TT,&
       Fm_VV,Fm_TV,Fm_Tn,Fm_Vn,Fm_nn)
...
subroutine test_IC
  ...
  d_T = saftvrmie_var(1)%dhs%d_T(i,j)
  d_TT = saftvrmie_var(1)%dhs%d_TT(i,j)
  s = saftvrmie_var(1)%sigma_eff%d(i,j)
  s_T = saftvrmie_var(1)%sigma_eff%d_T(i,j)
  s_TT = saftvrmie_var(1)%sigma_eff%d_TT(i,j)
  ...
  call convert_zeta_x_to_TVn(nc,0.0,1.0,0.0,saftvrmie_var(1)%zeta,&
       a1Cc,a1Cc_e,a1Cc_T,a1Cc_ee,a1Cc_TT,a1Cc_eT,a1Cc_eee,a1Cc_eeT,a1Cc_eTT,&
...
subroutine test_hard_sphere_diameter
  ...
  quantum_correction_hs = 2
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  d = saftvrmie_var(1)%dhs%d
  d_T = saftvrmie_var(1)%dhs%d_T
  d_TT = saftvrmie_var(1)%dhs%d_TT
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  print *,"T"
  do i=1,nc
     do j=1,nc
...
subroutine test_hard_sphere_Santos
  ...
  quantum_correction_hs = 2
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_Santos_eta(nc,n,V,difflevel,saftvrmie_var(1)%dhs,saftvrmie_var(1)%eta_hs)


  eta = saftvrmie_var(1)%eta_hs%zx
  ...
  call calc_Santos_eta(nc,n,V+V*eps,difflevel,saftvrmie_var(1)%dhs,eta_hs_l)
  print *,"Testing hypotetical pure fluid packing fraction"
  print *,"Volume"
  print *,saftvrmie_var(1)%eta_hs%zx
  print *,saftvrmie_var(1)%eta_hs%zx_V,(eta_hs_l%zx - saftvrmie_var(1)%eta_hs%zx)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_VV,(eta_hs_l%zx_V - saftvrmie_var(1)%eta_hs%zx_V)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_TV,(eta_hs_l%zx_T - saftvrmie_var(1)%eta_hs%zx_T)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_Vn,(eta_hs_l%zx_n - saftvrmie_var(1)%eta_hs%zx_n)/(V*eps)

  n(1) = n(1) + eps
  call calc_Santos_eta(nc,n,V,difflevel,saftvrmie_var(1)%dhs,eta_hs_l)
  print *,"n(1)"
  print *,saftvrmie_var(1)%eta_hs%zx_n(1),(eta_hs_l%zx - saftvrmie_var(1)%eta_hs%zx)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_Tn(1),(eta_hs_l%zx_T - saftvrmie_var(1)%eta_hs%zx_T)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_Vn(1),(eta_hs_l%zx_V - saftvrmie_var(1)%eta_hs%zx_V)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_nn(1,:),(eta_hs_l%zx_n - saftvrmie_var(1)%eta_hs%zx_n)/eps

  n = n0
  n(2) = n(2) + eps
  call calc_Santos_eta(nc,n,V,difflevel,saftvrmie_var(1)%dhs,eta_hs_l)
  print *,"n(2)"
  print *,saftvrmie_var(1)%eta_hs%zx_n(2),(eta_hs_l%zx - saftvrmie_var(1)%eta_hs%zx)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_Tn(2),(eta_hs_l%zx_T - saftvrmie_var(1)%eta_hs%zx_T)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_Vn(2),(eta_hs_l%zx_V - saftvrmie_var(1)%eta_hs%zx_V)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_nn(2,:),(eta_hs_l%zx_n - saftvrmie_var(1)%eta_hs%zx_n)/eps

  n = n0
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calc_Santos_eta(nc,n,V,difflevel,saftvrmie_var(1)%dhs,eta_hs_l)
  print *,"Temperature"
  print *,saftvrmie_var(1)%eta_hs%zx_T,(eta_hs_l%zx - saftvrmie_var(1)%eta_hs%zx)/(T*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_TT,(eta_hs_l%zx_T - saftvrmie_var(1)%eta_hs%zx_T)/(T*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_TV,(eta_hs_l%zx_V - saftvrmie_var(1)%eta_hs%zx_V)/(T*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_Tn,(eta_hs_l%zx_n - saftvrmie_var(1)%eta_hs%zx_n)/(T*eps)
  ...
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_Santos_eta(nc,n,V,difflevel,saftvrmie_var(1)%dhs,saftvrmie_var(1)%eta_hs)
  call calc_F11_Santos(nc,saftvrmie_var(1)%eta_hs,F,F_T,F_V,F_n,&
       F_TT,F_TV,F_Tn,F_VV,F_Vn,F_nn)
  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calc_Santos_eta(nc,n,V+V*eps,difflevel,saftvrmie_var(1)%dhs,saftvrmie_var(1)%eta_hs)
  call calc_F11_Santos(nc,saftvrmie_var(1)%eta_hs,F2,F2_T,F2_V,F2_n)
  ...
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_Santos_eta(nc,n,V,difflevel,saftvrmie_var(1)%dhs,saftvrmie_var(1)%eta_hs)
  call calc_pure_ahs_div_nRT(nc,saftvrmie_var(1)%eta_hs,F,F_T,F_V,F_n,&
       F_TT,F_TV,F_Tn,F_VV,F_Vn,F_nn)
  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calc_Santos_eta(nc,n,V+V*eps,difflevel,saftvrmie_var(1)%dhs,saftvrmie_var(1)%eta_hs)
  call calc_pure_ahs_div_nRT(nc,saftvrmie_var(1)%eta_hs,F2,F2_T,F2_V,F2_n)
  ...
  n = n0
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_virial_Bijk(nc,saftvrmie_var(1)%dhs,B_ijk,B_ijk_T,B_ijk_TT)
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  ...
  n = n0
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_virial_B2(nc,n,saftvrmie_var(1)%dhs,B2s,B2s_T,B2s_TT,B2s_Tn,B2s_n,B2s_nn)
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_virial_B2(nc,n,saftvrmie_var(1)%dhs,B2s2,B2s2_T,B2s2_TT,B2s2_Tn,B2s2_n,B2s2_nn)
  print *,"Temperature"
  print *,B2s
  ...
  n = n0
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_virial_B3(nc,n,saftvrmie_var(1)%dhs,B3s,B3s_T,B3s_TT,B3s_Tn,B3s_n,B3s_nn)
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_virial_B3(nc,n,saftvrmie_var(1)%dhs,B3s2,B3s2_T,B3s2_TT,B3s2_Tn,B3s2_n,B3s2_nn)
  print *,"Temperature"
  print *,B3s
  ...
  call calc_hardsphere_virial_B2(nc,n,saftvrmie_var(1)%dhs,B2s,B2s_T,B2s_TT,B2s_Tn,B2s_n,B2s_nn)
  call calc_hardsphere_virial_B3(nc,n,saftvrmie_var(1)%dhs,B3s,B3s_T,B3s_TT,B3s_Tn,B3s_n,B3s_nn)
  call calc_Santos_F12_or_F22(nc,n,saftvrmie_var(1)%dhs,.true.,B2s,B2s_T,B2s_TT,B2s_Tn,B2s_n,B2s_nn,&
  ...
  call calc_hardsphere_virial_B2(nc,n,saftvrmie_var(1)%dhs,B2s,B2s_T,B2s_TT,B2s_Tn,B2s_n,B2s_nn)
  call calc_hardsphere_virial_B3(nc,n,saftvrmie_var(1)%dhs,B3s,B3s_T,B3s_TT,B3s_Tn,B3s_n,B3s_nn)
  call calc_Santos_F12_or_F22(nc,n,saftvrmie_var(1)%dhs,.false.,B2s,B2s_T,B2s_TT,B2s_Tn,B2s_n,B2s_nn,&
       B3s,B3s_T,B3s_TT,B3s_Tn,B3s_n,B3s_nn,&
  ...
  n = n0
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_helmholtzenergy_santos(nc,T,V,n,saftvrmie_var(1),a,a_T,a_V,a_n,&
       a_TT,a_TV,a_Tn,a_VV,a_Vn,a_nn)
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_helmholtzenergy_santos(nc,T+T*eps,V,n,saftvrmie_var(1),a2,a2_T,a2_V,a2_n,&
  ...
  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calc_hardsphere_helmholtzenergy_santos(nc,T,V+V*eps,n,saftvrmie_var(1),a2,a2_T,a2_V,a2_n,&
       a2_TT,a2_TV,a2_Tn,a2_VV,a2_Vn,a2_nn)
  print *,"Volume"
  ...
  n(1) = n(1) + eps
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_helmholtzenergy_santos(nc,T,V,n,saftvrmie_var(1),a2,a2_T,a2_V,a2_n,&
       a2_TT,a2_TV,a2_Tn,a2_VV,a2_Vn,a2_nn)
  print *,"n(1)"
...
subroutine test_hardsphere_pure()
  ...
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_eta_dij(nc,n,V,difflevel,saftvrmie_var(1)%dhs,saftvrmie_var(1)%eta_hs)

  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calc_eta_dij(nc,n,V+V*eps,difflevel,saftvrmie_var(1)%dhs,eta_hs_l)
  print *,"Testing hypotetical pure fluid packing fraction"
  print *,"Volume"
  print *,saftvrmie_var(1)%eta_hs%zx
  print *,saftvrmie_var(1)%eta_hs%zx_V,(eta_hs_l%zx - saftvrmie_var(1)%eta_hs%zx)/(V*eps)
  ...
  print *,saftvrmie_var(1)%eta_hs%zx_TV,(eta_hs_l%zx_T - saftvrmie_var(1)%eta_hs%zx_T)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_Vn,(eta_hs_l%zx_n - saftvrmie_var(1)%eta_hs%zx_n)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_VVV,(eta_hs_l%zx_VV - saftvrmie_var(1)%eta_hs%zx_VV)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_VVT,(eta_hs_l%zx_TV - saftvrmie_var(1)%eta_hs%zx_TV)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_VTT,(eta_hs_l%zx_TT - saftvrmie_var(1)%eta_hs%zx_TT)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_VTn,(eta_hs_l%zx_Tn - saftvrmie_var(1)%eta_hs%zx_Tn)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_VVn,(eta_hs_l%zx_Vn - saftvrmie_var(1)%eta_hs%zx_Vn)/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_Vnn(1,:),(eta_hs_l%zx_nn(1,:) - saftvrmie_var(1)%eta_hs%zx_nn(1,:))/(V*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_Vnn(2,:),(eta_hs_l%zx_nn(2,:) - saftvrmie_var(1)%eta_hs%zx_nn(2,:))/(V*eps)

  n(1) = n(1) + eps
  call calc_eta_dij(nc,n,V,difflevel,saftvrmie_var(1)%dhs,eta_hs_l)
  print *,"n(1)"
  print *,saftvrmie_var(1)%eta_hs%zx_n(1),(eta_hs_l%zx - saftvrmie_var(1)%eta_hs%zx)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_Tn(1),(eta_hs_l%zx_T - saftvrmie_var(1)%eta_hs%zx_T)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_Vn(1),(eta_hs_l%zx_V - saftvrmie_var(1)%eta_hs%zx_V)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_nn(1,:),(eta_hs_l%zx_n - saftvrmie_var(1)%eta_hs%zx_n)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_VTn(1),(eta_hs_l%zx_TV - saftvrmie_var(1)%eta_hs%zx_TV)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_VVn(1),(eta_hs_l%zx_VV - saftvrmie_var(1)%eta_hs%zx_VV)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_Vnn(1,:),(eta_hs_l%zx_Vn - saftvrmie_var(1)%eta_hs%zx_Vn)/eps
  ...
  print *,saftvrmie_var(1)%eta_hs%zx_Vn(2),(eta_hs_l%zx_V - saftvrmie_var(1)%eta_hs%zx_V)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_nn(2,:),(eta_hs_l%zx_n - saftvrmie_var(1)%eta_hs%zx_n)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_VTn(2),(eta_hs_l%zx_TV - saftvrmie_var(1)%eta_hs%zx_TV)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_VVn(2),(eta_hs_l%zx_VV - saftvrmie_var(1)%eta_hs%zx_VV)/eps
  print *,saftvrmie_var(1)%eta_hs%zx_Vnn(2,:),(eta_hs_l%zx_Vn - saftvrmie_var(1)%eta_hs%zx_Vn)/eps
  ...
  print *,saftvrmie_var(1)%eta_hs%zx_TV,(eta_hs_l%zx_V - saftvrmie_var(1)%eta_hs%zx_V)/(T*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_Tn,(eta_hs_l%zx_n - saftvrmie_var(1)%eta_hs%zx_n)/(T*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_VVT,(eta_hs_l%zx_VV - saftvrmie_var(1)%eta_hs%zx_VV)/(T*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_VTT,(eta_hs_l%zx_TV - saftvrmie_var(1)%eta_hs%zx_TV)/(T*eps)
  print *,saftvrmie_var(1)%eta_hs%zx_VTn,(eta_hs_l%zx_Vn - saftvrmie_var(1)%eta_hs%zx_Vn)/(T*eps)

  print *,"Testing entire pure EoS"

  n = n0
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_helmholtzenergy_pure(nc,T,V,n,saftvrmie_var(1),a,a_T,a_V,a_n,&
       a_TT,a_TV,a_Tn,a_VV,a_Vn,a_nn)
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_helmholtzenergy_pure(nc,T+T*eps,V,n,saftvrmie_var(1),a2,a2_T,a2_V,a2_n,&
       a2_TT,a2_TV,a2_Tn,a2_VV,a2_Vn,a2_nn)
  print *,"Temperature"
  print *,a
  print *,a_T,(a2 - a)/(T*eps)
  ...
  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calc_hardsphere_helmholtzenergy_pure(nc,T,V+V*eps,n,saftvrmie_var(1),a2,a2_T,a2_V,a2_n,&
       a2_TT,a2_TV,a2_Tn,a2_VV,a2_Vn,a2_nn)
  print *,"Volume"
  print *,a_V,(a2 - a)/(V*eps)
  print *,a_TV,(a2_T - a_T)/(V*eps)
  ...
  n(1) = n(1) + eps
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_hardsphere_helmholtzenergy_pure(nc,T,V,n,saftvrmie_var(1),a2,a2_T,a2_V,a2_n,&
       a2_TT,a2_TV,a2_Tn,a2_VV,a2_Vn,a2_nn)
  print *,"n(1)"
  print *,a_n(1),(a2 - a)/(eps)
  print *,a_Tn(1),(a2_T - a_T)/(eps)
  ...
  print *
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_d_pure(nc,n,V,2,saftvrmie_var(1)%dhs,saftvrmie_var(1)%d_pure)

  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calc_d_pure(nc,n,V+V*eps,2,saftvrmie_var(1)%dhs,d_pure)
  print *,"Volume"
  print *,saftvrmie_var(1)%d_pure%zx
  print *,saftvrmie_var(1)%d_pure%zx_V,(d_pure%zx - saftvrmie_var(1)%d_pure%zx)/(V*eps)
  print *,saftvrmie_var(1)%d_pure%zx_VV,(d_pure%zx_V - saftvrmie_var(1)%d_pure%zx_V)/(V*eps)
  print *,saftvrmie_var(1)%d_pure%zx_TV,(d_pure%zx_T - saftvrmie_var(1)%d_pure%zx_T)/(V*eps)
  print *,saftvrmie_var(1)%d_pure%zx_Vn,(d_pure%zx_n - saftvrmie_var(1)%d_pure%zx_n)/(V*eps)

  n(1) = n(1) + eps
  call calc_d_pure(nc,n,V,2,saftvrmie_var(1)%dhs,d_pure)
  print *,"n(1)"
  print *,saftvrmie_var(1)%d_pure%zx_n(1),(d_pure%zx - saftvrmie_var(1)%d_pure%zx)/eps
  print *,saftvrmie_var(1)%d_pure%zx_Tn(1),(d_pure%zx_T - saftvrmie_var(1)%d_pure%zx_T)/eps
  print *,saftvrmie_var(1)%d_pure%zx_Vn(1),(d_pure%zx_V - saftvrmie_var(1)%d_pure%zx_V)/eps
  print *,saftvrmie_var(1)%d_pure%zx_nn(1,:),(d_pure%zx_n - saftvrmie_var(1)%d_pure%zx_n)/eps

  n = n0
  n(2) = n(2) + eps
  call calc_d_pure(nc,n,V,2,saftvrmie_var(1)%dhs,d_pure)
  print *,"n(2)"
  print *,saftvrmie_var(1)%d_pure%zx_n(2),(d_pure%zx - saftvrmie_var(1)%d_pure%zx)/eps
  print *,saftvrmie_var(1)%d_pure%zx_Tn(2),(d_pure%zx_T - saftvrmie_var(1)%d_pure%zx_T)/eps
  print *,saftvrmie_var(1)%d_pure%zx_Vn(2),(d_pure%zx_V - saftvrmie_var(1)%d_pure%zx_V)/eps
  print *,saftvrmie_var(1)%d_pure%zx_nn(2,:),(d_pure%zx_n - saftvrmie_var(1)%d_pure%zx_n)/eps

  n = n0
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calc_d_pure(nc,n,V,2,saftvrmie_var(1)%dhs,d_pure)
  print *,"Temperature"
  print *,saftvrmie_var(1)%d_pure%zx_T,(d_pure%zx - saftvrmie_var(1)%d_pure%zx)/(T*eps)
  print *,saftvrmie_var(1)%d_pure%zx_TT,(d_pure%zx_T - saftvrmie_var(1)%d_pure%zx_T)/(T*eps)
  print *,saftvrmie_var(1)%d_pure%zx_TV,(d_pure%zx_V - saftvrmie_var(1)%d_pure%zx_V)/(T*eps)
  print *,saftvrmie_var(1)%d_pure%zx_Tn,(d_pure%zx_n - saftvrmie_var(1)%d_pure%zx_n)/(T*eps)
  ...
  s_TT = 0.0
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calcXDifferentialsPureHSRef(nc,s,s_T,s_TT,saftvrmie_var(1)%d_pure,x0r)
  call preCalcSAFTVRMie(nc,T,V+V*eps,n,2,saftvrmie_var(1))
  call calc_d_pure(nc,n,V+V*eps,2,saftvrmie_var(1)%dhs,d_pure)
...
contains
  subroutine calc_a(nc,T,V,n,a1,a1_T,a1_V,a1_n,a1_TT,a1_VV,a1_TV,a1_Tn,a1_Vn,a1_nn,&
    ...
    use saftvrmie_containers, only: allocate_saftvrmie_zeta, cleanup_saftvrmie_zeta, &
         saftvrmie_zeta, saftvrmie_var, saftvrmie_param
    use saftvrmie_interface, only: preCalcSAFTVRMie
    ...
    s_T = saftvrmie_var(1)%sigma_eff%d_T(i,j)
    s_TT = saftvrmie_var(1)%sigma_eff%d_TT(i,j)
    call calcXDifferentialsPureHSRef(nc,s,s_T,s_TT,saftvrmie_var(1)%d_pure,y)
    y0 = y%zx
    e0 = saftvrmie_var(1)%zeta%zx
    call calcBtilde(y0,e0,lambda,eps,Bea,Bea_e,Bea_y,Bea_ee,Bea_yy,Bea_ey,&
         Bea_eee,Bea_eey,Bea_eyy,fac_in=C)
    a1 = Bea
    call convert_zeta_zeta_to_TVn(nc,y,saftvrmie_var(1)%zeta,&
...
subroutine test_delta_Ac(Ti,Vi,ni,doInit)
  ...
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calc_delta_Ac(nc,T,V,n,r_cut,saftvrmie_var(1),&
       F,F_T,F_V,F_n,F_TT,F_VV,F_TV,F_Tn,F_Vn,F_nn)
  call calc_delta_Ac(nc,T,V+V*eps,n,r_cut,saftvrmie_var(1),&
  ...
  n = n0
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,saftvrmie_var(1))
  call calc_delta_Ac(nc,T+T*eps,V,n,r_cut,saftvrmie_var(1),&
       Fp,Fp_T,Fp_V,Fp_n,Fp_TT,Fp_VV,Fp_TV,Fp_Tn,Fp_Vn,Fp_nn)
...
subroutine print_saftvrmie_model(Ti,Vi,ni,doInit)
  ...
  call calcFresSAFTVRMie(nc,T,V,n,F=F,F_n=F_n)
...
subroutine test_a2chi(T,V,n)
  ...
  call calcA2(nc,T,V+V*eps,n,s_vc,&
       ...
       a2_VV=F2_VV,a2_TV=F2_TV,a2_Tn=F2_Tn,a2_Vn=F2_Vn,a2_nn=F2_nn)
  print *,"V"
  print *,"a2_V ",saftvrmie_var(1)%a2chij%am_V(j,j),(s_vc%a2chij%am(j,j)-saftvrmie_var(1)%a2chij%am(j,j))/(eps*V)
  print *,"a2_VV ",saftvrmie_var(1)%a2chij%am_VV(j,j),(s_vc%a2chij%am_V(j,j)-saftvrmie_var(1)%a2chij%am_V(j,j))/(eps*V)
  print *,"a2_VVV ",saftvrmie_var(1)%a2chij%am_VVV(j,j),(s_vc%a2chij%am_VV(j,j)-saftvrmie_var(1)%a2chij%am_VV(j,j))/(eps*V)
  print *,"a2_TV ",saftvrmie_var(1)%a2chij%am_TV(j,j),(s_vc%a2chij%am_T(j,j)-saftvrmie_var(1)%a2chij%am_T(j,j))/(eps*V)
  print *,"a2_VVT ",saftvrmie_var(1)%a2chij%am_VVT(j,j),(s_vc%a2chij%am_TV(j,j)-saftvrmie_var(1)%a2chij%am_TV(j,j))/(eps*V)
  print *,"a2_VTT ",saftvrmie_var(1)%a2chij%am_VTT(j,j),(s_vc%a2chij%am_TT(j,j)-saftvrmie_var(1)%a2chij%am_TT(j,j))/(eps*V)
  print *,"a2_Vn ",saftvrmie_var(1)%a2chij%am_Vn(:,j,j),(s_vc%a2chij%am_n(:,j,j)-saftvrmie_var(1)%a2chij%am_n(:,j,j))/(eps*V)
  print *,"a2_VVn ",saftvrmie_var(1)%a2chij%am_VVn(:,j,j),(s_vc%a2chij%am_Vn(:,j,j)-saftvrmie_var(1)%a2chij%am_Vn(:,j,j))/(eps*V)
  print *,"a2_VTn ",saftvrmie_var(1)%a2chij%am_VTn(:,j,j),(s_vc%a2chij%am_Tn(:,j,j)-saftvrmie_var(1)%a2chij%am_Tn(:,j,j))/(eps*V)
  ...
  call calcA2(nc,T+T*eps,V,n,s_vc,&
       F2,a2_T=F2_T,a2_V=F2_V,a2_n=F2_n,a2_TT=F2_TT,&
       a2_VV=F2_VV,a2_TV=F2_TV,a2_Tn=F2_Tn,a2_Vn=F2_Vn,a2_nn=F2_nn)
  print *,"a2_T ",saftvrmie_var(1)%a2chij%am_T(j,j),(s_vc%a2chij%am(j,j)-saftvrmie_var(1)%a2chij%am(j,j))/(eps*T)
  print *,"a2_TT ",saftvrmie_var(1)%a2chij%am_VV(j,j),(s_vc%a2chij%am_T(j,j)-saftvrmie_var(1)%a2chij%am_T(j,j))/(eps*T)
  print *,"a2_TV ",saftvrmie_var(1)%a2chij%am_TV(j,j),(s_vc%a2chij%am_V(j,j)-saftvrmie_var(1)%a2chij%am_V(j,j))/(eps*T)
  print *,"a2_VVT ",saftvrmie_var(1)%a2chij%am_VVT(j,j),(s_vc%a2chij%am_VV(j,j)-saftvrmie_var(1)%a2chij%am_VV(j,j))/(eps*T)
  print *,"a2_VTT ",saftvrmie_var(1)%a2chij%am_VTT(j,j),(s_vc%a2chij%am_TV(j,j)-saftvrmie_var(1)%a2chij%am_TV(j,j))/(eps*T)
  print *,"a2_Tn ",saftvrmie_var(1)%a2chij%am_Tn(:,j,j),(s_vc%a2chij%am_n(:,j,j)-saftvrmie_var(1)%a2chij%am_n(:,j,j))/(eps*T)
  print *,"a2_VTn ",saftvrmie_var(1)%a2chij%am_VTn(:,j,j),(s_vc%a2chij%am_Vn(:,j,j)-saftvrmie_var(1)%a2chij%am_Vn(:,j,j))/(eps*T)
  ...
  call calcA2(nc,T,V,n1,s_vc,&
       F2,a2_T=F2_T,a2_V=F2_V,a2_n=F2_n,a2_TT=F2_TT,&
       a2_VV=F2_VV,a2_TV=F2_TV,a2_Tn=F2_Tn,a2_Vn=F2_Vn,a2_nn=F2_nn)
  print *,"a2_n ",saftvrmie_var(1)%a2chij%am_n(:,j,j),(s_vc%a2chij%am(j,j)-saftvrmie_var(1)%a2chij%am(j,j))/(eps*n(j))
  print *,"a2_nn ",saftvrmie_var(1)%a2chij%am_nn(:,j,j,j),(s_vc%a2chij%am_n(:,j,j)-saftvrmie_var(1)%a2chij%am_n(:,j,j))/(eps*n(j))
  print *,"a2_Tn ",saftvrmie_var(1)%a2chij%am_Tn(:,j,j),(s_vc%a2chij%am_T(j,j)-saftvrmie_var(1)%a2chij%am_T(j,j))/(eps*n(j))
  print *,"a2_Vn ",saftvrmie_var(1)%a2chij%am_Vn(:,j,j),(s_vc%a2chij%am_V(j,j)-saftvrmie_var(1)%a2chij%am_V(j,j))/(eps*n(j))
  print *,"a2_VVn",saftvrmie_var(1)%a2chij%am_VVn(:,j,j),(s_vc%a2chij%am_VV(j,j)-saftvrmie_var(1)%a2chij%am_VV(j,j))/(eps*n(j))
  print *,"a2_Vnn ",saftvrmie_var(1)%a2chij%am_Vnn(:,j,j,j),&
       (s_vc%a2chij%am_Vn(:,j,j)-saftvrmie_var(1)%a2chij%am_Vn(:,j,j))/(eps*n(j))
  print *,"a2_VTn ",saftvrmie_var(1)%a2chij%am_VTn(:,j,j),(s_vc%a2chij%am_TV(j,j)-saftvrmie_var(1)%a2chij%am_TV(j,j))/(eps*n(j))
...
subroutine test_mixKhs(T,V,n)
  ...
  j = 2
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call mbar(nc,n,saftvrmie_var(1)%dhs,M)
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,s_vc)
  ...
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call KandL(nc,n,saftvrmie_var(1)%dhs,zK,zL)
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,s_vc)
  ...
  j = 1
  call preCalcSAFTVRMie(nc,T,V,n,2,saftvrmie_var(1))
  call calcMixKhsTVn(nc,T,V,n,2,saftvrmie_var(1))
  print *,"Khs num",saftvrmie_var(1)%Khs%zx
  call calcMixKhsTVn(nc,T,V,n,2,saftvrmie_var(1))
  print *,"Testing test_mixKhs"
  print *,"Khs ",saftvrmie_var(1)%Khs%zx
  ...
  print *,"V"
  print *,"Khs_V ",saftvrmie_var(1)%Khs%zx_V,(s_vc%Khs%zx-saftvrmie_var(1)%Khs%zx)/(eps*V),s_vc_pure%Khs%zx_V
  print *,"Khs_VV ",saftvrmie_var(1)%Khs%zx_VV,(s_vc%Khs%zx_V-saftvrmie_var(1)%Khs%zx_V)/(eps*V),s_vc_pure%Khs%zx_VV
  !print *,"Khs_VVV ",saftvrmie_var(1)%Khs%zx_VVV,(s_vc%Khs%zx_VV-saftvrmie_var(1)%Khs%zx_VV)/(eps*V)
  print *,"Khs_TV ",saftvrmie_var(1)%Khs%zx_TV,(s_vc%Khs%zx_T-saftvrmie_var(1)%Khs%zx_T)/(eps*V),s_vc_pure%Khs%zx_TV
  !print *,"Khs_VVT ",saftvrmie_var(1)%Khs%zx_VVT(j,j),(s_vc%Khs%zx_TV(j,j)-saftvrmie_var(1)%Khs%zx_TV(j,j))/(eps*V)
  !print *,"Khs_VTT ",saftvrmie_var(1)%Khs%zx_VTT(j,j),(s_vc%Khs%zx_TT(j,j)-saftvrmie_var(1)%Khs%zx_TT(j,j))/(eps*V)
  print *,"Khs_Vn ",saftvrmie_var(1)%Khs%zx_Vn(j),(s_vc%Khs%zx_n(j)-saftvrmie_var(1)%Khs%zx_n(j))/(eps*V),s_vc_pure%Khs%zx_Vn(j)
  !print *,"Khs_VVn ",saftvrmie_var(1)%Khs%zx_VVn(:,j,j),(s_vc%Khs%zx_Vn(:,j,j)-saftvrmie_var(1)%Khs%zx_Vn(:,j,j))/(eps*V)
  !print *,"Khs_VTn ",saftvrmie_var(1)%Khs%zx_VTn(:,j,j),(s_vc%Khs%zx_Tn(:,j,j)-saftvrmie_var(1)%Khs%zx_Tn(:,j,j))/(eps*V)

  print *,"T"
  call preCalcSAFTVRMie(nc,T+T*eps,V,n,2,s_vc)
  call calcMixKhsTVn(nc,T+T*eps,V,n,2,s_vc)
  print *,"Khs_T ",saftvrmie_var(1)%Khs%zx_T,(s_vc%Khs%zx-saftvrmie_var(1)%Khs%zx)/(eps*T),s_vc_pure%Khs%zx_T
  print *,"Khs_TT ",saftvrmie_var(1)%Khs%zx_TT,(s_vc%Khs%zx_T-saftvrmie_var(1)%Khs%zx_T)/(eps*T),s_vc_pure%Khs%zx_TT
  print *,"Khs_TV ",saftvrmie_var(1)%Khs%zx_TV,(s_vc%Khs%zx_V-saftvrmie_var(1)%Khs%zx_V)/(eps*T),s_vc_pure%Khs%zx_TV
  !print *,"Khs_VVT ",saftvrmie_var(1)%Khs%zx_VVT(j,j),(s_vc%Khs%zx_VV(j,j)-saftvrmie_var(1)%Khs%zx_VV(j,j))/(eps*T)
  !print *,"Khs_VTT ",saftvrmie_var(1)%Khs%zx_VTT(j,j),(s_vc%Khs%zx_TV(j,j)-saftvrmie_var(1)%Khs%zx_TV(j,j))/(eps*T)
  print *,"Khs_Tn ",saftvrmie_var(1)%Khs%zx_Tn(j),(s_vc%Khs%zx_n(j)-saftvrmie_var(1)%Khs%zx_n(j))/(eps*T),s_vc_pure%Khs%zx_Tn(j)
  !print *,"Khs_VTn ",saftvrmie_var(1)%Khs%zx_VTn(:,j,j),(s_vc%Khs%zx_Vn(:,j,j)-saftvrmie_var(1)%Khs%zx_Vn(:,j,j))/(eps*T)

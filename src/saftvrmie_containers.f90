...
contains
  ...
  subroutine init_saftvrmie_containers(nc,comp,setno,mixing)
    ...
    ! Locals
    integer :: setno_local(nc), fh_orders(nc), i, nthreads, err
    ...
    ! Get component data
    call getSaftVrMieParams(nc,comp,eosSAFT_VR_MIE,setno_local, saftvrmie_param%comp,fh_orders=fh_orders)
  ...
  subroutine set_saftvrmie_pure_fluid_deBoer(ic,Lambda)
    use tpconst, only: kB_const, h_const

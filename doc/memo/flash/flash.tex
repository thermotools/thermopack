%
\documentclass[english,sintefheadings,12pt]{sintefmemo}
...
% (norsk,  ikke-twoside, ikke-sintefheadings,
% ikke-sintefcolour, ikke-lucida og ikke-times er default).
%
% Svend Tollak Munkejord, svend.t.munkejord@sintef.no, 2002-07-03
...
\memooverskrift{MEMO}
\gjelder{DA1202: Thermodynamic equilibrium algorithms - Reimplemented
  in a new framework.}
\forfatter{Morten Hammer}
\filnavn{thermopack.tex}
\gaartili{Svend Tollak Munkejord}{\checked}{\checked}{}{\checked}
\gaartilii{\O ivind Wilhelmsen}{\checked}{\checked}{}{}
\gaartiliii{Members of the \coto~Dynamics project}{}{}{\checked}{}
% \gaartiliii{Hermansen}{X}{}{}{}
% \gaartiliv{Harald V}{}{}{X}{}
% \gaartilv{Meg selv}{}{X}{}{}
% \gaartilvi{Julenissen}{X}{X}{}{}
% \gaartilvii{Jess!}{X}{X}{X}{X}
\prosjektnummer{16X86302}
\usepackage{isodate}
\isodate
\dato{\today}
...
\avdeling{Gas Technology}
\avdelingfot{Gas Technology}
\besoeksadresse{Kolbjørn Hejes vei 1A}
%\lokalfax{}

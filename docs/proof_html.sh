...
# Which is aquired when you run `bundle install`, from the 'html-proofer' gem in the Gemfile.
...
#
# We ignore the 403 status code, because doi.org gives us a 403, and the cli argument to ignore doi adresses does not seem to work.
#
